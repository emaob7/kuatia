...
const Vehiculo1 = () => {
  ...
  const renderScreen = () => {
    switch (activeScreen) {
      case '1':
        return <Habi1 showCamera={showCamera} setShowCamera={setShowCamera} />;
      case '2':
        return <Reg1 showCamera={showCamera} setShowCamera={setShowCamera} />;
        case '3':
            return <Cedu1 showCamera={showCamera} setShowCamera={setShowCamera} />;
        case '4':
            return <CVerde1 showCamera={showCamera} setShowCamera={setShowCamera} />;
      default:
        return <Cedu1 showCamera={showCamera} setShowCamera={setShowCamera} />;
    }
  };
