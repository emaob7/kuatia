      ...
      <TouchableOpacity onPress={handleTakePhoto} style={styles.circleButton}>
        ...
        <View style={styles.imageContainer}>
          ...
          {currentPhoto ? (
            <>
             <>
             <Text style={styles.super3}>Cedula Verde 3</Text>
             <Text style={styles.textAyuda2}>toca la imagen para ampliar</Text>
             </>
            <>
            <TouchableOpacity onPress={() => openModal([photo73, photo83])}>
              <Image source={{ uri: photo73 }} style={styles.image} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => openModal([photo73, photo83])}>
              <Image source={{ uri: photo83 }} style={styles.image} />
            </TouchableOpacity>
            <ImageModal 
